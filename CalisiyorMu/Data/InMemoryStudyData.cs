...
namespace CalisiyorMu.Data
{
    public class InMemoryStudyData : IStudyData
    {
        ...
        public IEnumerable<Study> GetAll() => studies;



        public Study GetLast() => studies.Last();
        ...
        public int PomodoroCount() => throw new NotImplementedException();



        public double WeekAvarage() => throw new NotImplementedException();
    }
}